...
btn.addEventListener("click",(e)=>{
    ...
    newlist.innerHTML=` <p>${content}</p>  
    <div class="twobtn">   
       <button class="btn btn2 btn-success"  onclick="edit(this)"> edit</button>
       <button class="btn btn3 remove btn-danger" onclick="func(this)"> Remove</button>
    </div> `;
